    ...
    <div className="flex min-h-screen w-full flex-col bg-slate-50 text-slate-900">
      ...
      <main className="flex w-full flex-1 items-center justify-center p-0 md:p-6 lg:p-0">
        ...
        <section className="relative hidden w-1/2 overflow-hidden bg-blue-800 lg:flex">
          ...
          <img
            src={heroImage}
            alt="Nhóm học viên học cùng nhau"
          ...
          <div className="relative z-20 flex h-full w-full flex-col justify-end p-12">
            <div className="max-w-md">
              ...
              <p className="mb-12 text-lg leading-8 text-blue-100">
                Tham gia cùng hàng ngàn sinh viên và gia sư chuyên nghiệp để nâng
                tầm kiến thức của bạn ngay hôm nay.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between py-2">
                <label className="group flex cursor-pointer items-center gap-2">
                  <input
                    type="checkbox"
                    className="h-4 w-4 cursor-pointer rounded border-slate-300 text-blue-700 focus:ring-blue-700"
                  />
                  <span className="text-sm text-slate-500 transition group-hover:text-slate-900">
                    Ghi nhớ đăng nhập
                  </span>
                </label>
